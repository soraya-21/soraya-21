...
<p align="center">
  <strong>Backend & AI Engineer - Master's in Artificial Intelligence & Data Management</strong><br>
  Open to new opportunities (CDI)
</p>
...
I'm Soraya, a Backend & AI Engineer who believes good code, like good philosophy, should be clear, honest and built to last. I put a lot of care into doing/building useful things, and I genuinely have fun with it, especially when there's something new to discover or figure out.<br><br>
Also, I love digging into history, reading about human behavior and personal growth, or getting lost in a good playlist. Understanding why people think and act the way they do matters a lot to me, because at the end of the day, we build for people and with people.
...
| Power BI Commercial Dashboard | Business activity monitoring dashboard | Power BI, DAX |
| Blood Donation Tracker | Application to track blood donation campaigns with web scraping | Django, Python, VueJS |
| National Activity Monitoring Platform | Nationwide backend platform with authentication and REST APIs | Django, React, PostgreSQL |
| AREA | Automation platform where an action on one app triggers reactions on others (IFTTT-like). Worked on the backend. | Python, Django, REST APIs |
